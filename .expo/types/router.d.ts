...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/files` | `/files` | `/(tabs)/` | `/(tabs)` | `/(tabs)/settings` | `/settings` | `/auth`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/session/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/session/[podId]`;
